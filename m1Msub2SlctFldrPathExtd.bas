Attribute VB_Name = "m1Msub2SlctFldrPathExtd"
...
'//モジュールメモリ
  Private Const meMstrMdlName As String = "m1Msub2SlctFldrPathExtd"
...
'//処理実行
    Call callm1Msub2SlctFldrPathExtd
...
'End Sub
'◆ModuleProc名_フォルダを選択してそのパスを取得してシートに書き出す
Private Sub callm1Msub2SlctFldrPathExtd()
...
'
Private Sub resetConstantInm1Msub2SlctFldrPathExtd()
'//m1Msub2SlctFldrPathExtdモジュールのモジュールメモリのリセット処理
    Call m1Msub2SlctFldrPathExtd.resetConstant
End Sub
