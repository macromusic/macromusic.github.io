Attribute VB_Name = "xRefShtFldrLst"
...
'//モジュールメモリ
  Private Const meMstrMdlName As String = "xRefShtFldrLst"
...
'End Sub
'◆ModuleProc名_エクセルシート上に記載されたフォルダパス一覧を取得する
Private Sub callxRefShtFldrLst()
...
'    'myZstrFldrName(k) : フォルダ名
'    'myZstrFldrPath(k) : フォルダパス
    Call xRefShtFldrLst.callProc( _
...
'
Private Sub resetConstantInxRefShtFldrLst()
'//xRefShtFldrLstモジュールのモジュールメモリのリセット処理
    Call xRefShtFldrLst.resetConstant
End Sub
