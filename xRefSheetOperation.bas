Attribute VB_Name = "xRefSheetOperation"
...
'//モジュールメモリ
  Private Const meMstrMdlName As String = "xRefSheetOperation"
...
'◆ModuleProc名_エクセルブック内の全シートに対して処理を実行する
Private Sub callxRefSheetOperation()
  Dim myXbisCompFlag As Boolean
    Call xRefSheetOperation.callProc(myXbisCompFlag)
...
'
Private Sub resetConstantInxRefSheetOperation()
'//xRefSheetOperationモジュールのモジュールメモリのリセット処理
    Call xRefSheetOperation.resetConstant
End Sub
