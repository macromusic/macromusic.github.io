Attribute VB_Name = "m1Msub3SubFileLstExtd"
...
'//モジュールメモリ
  Private Const meMstrMdlName As String = "m1Msub3SubFileLstExtd"
...
'//処理実行
    Call callm1Msub3SubFileLstExtd
...
'End Sub
'◆ModuleProc名_指定ディレクトリ内のサブファイル一覧を取得してシートに書き出す
Private Sub callm1Msub3SubFileLstExtd()
...
'
Private Sub resetConstantInm1Msub3SubFileLstExtd()
'//m1Msub3SubFileLstExtdモジュールのモジュールメモリのリセット処理
    Call m1Msub3SubFileLstExtd.resetConstant
End Sub
