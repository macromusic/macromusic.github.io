...
'//モジュールメモリ
  Private Const meMstrMdlName As String = "xRefSrchSht"
...
'
Private Sub resetxRefSrchSht()
'//xRefSrchShtモジュールのモジュールメモリのリセット処理
    Call xRefSrchSht.resetConstant
End Sub
